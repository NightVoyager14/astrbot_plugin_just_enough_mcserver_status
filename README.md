...
![Version](https://img.shields.io/badge/JEMSS-v1.2.1--dev-EE82EE)<!-- Release 使用： ![Version](https://img.shields.io/badge/JEMSS-v1.x.x-228B22) -->
...
- `mcbe_server_status` — 为AI提供 Bedrock Edition 查询接口
